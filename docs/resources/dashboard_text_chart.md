...
page_title: "splight_dashboard_text_chart Resource - terraform-provider-splight"
subcategory: ""
description: |-
  
---

# splight_dashboard_text_chart (Resource)
...
```shell
terraform import [options] splight_dashboard_text_chart.<name> <dashboard_chart_id>
```
