...
page_title: "splight_dashboard_alertlist_chart Resource - terraform-provider-splight"
subcategory: ""
description: |-
  
---

# splight_dashboard_alertlist_chart (Resource)
...
- `alert_list_type` (String) alert list type
- `collection` (String)
...
```shell
terraform import [options] splight_dashboard_alertlist_chart.<name> <dashboard_chart_id>
```
