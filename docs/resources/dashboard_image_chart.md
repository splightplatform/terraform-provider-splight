...
page_title: "splight_dashboard_image_chart Resource - terraform-provider-splight"
subcategory: ""
description: |-
  
---

# splight_dashboard_image_chart (Resource)
...
```shell
terraform import [options] splight_dashboard_image_chart.<name> <dashboard_chart_id>
```
