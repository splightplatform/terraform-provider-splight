...
page_title: "splight_dashboard_commandlist_chart Resource - terraform-provider-splight"
subcategory: ""
description: |-
  
---

# splight_dashboard_commandlist_chart (Resource)
...
- `collection` (String)
- `command_list_type` (String) [table|button_list]command list type
...
```shell
terraform import [options] splight_dashboard_commandlist_chart.<name> <dashboard_chart_id>
```
