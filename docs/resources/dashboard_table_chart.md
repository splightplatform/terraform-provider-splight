...
page_title: "splight_dashboard_table_chart Resource - terraform-provider-splight"
subcategory: ""
description: |-
  
---

# splight_dashboard_table_chart (Resource)
...
- `y_axis_unit` (String) y axis unit
...
```shell
terraform import [options] splight_dashboard_table_chart.<name> <dashboard_chart_id>
```
